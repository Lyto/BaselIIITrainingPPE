...
public class MenuInvite {
	...
	public MenuInvite() {
		...
		bpane.setCenter(new Accueil(null, stage));
	...
	public VBox createMenu() {
		...
		Hyperlink h1_chap5 = new Hyperlink(
				"Les outils de réduction de l'exposition");
